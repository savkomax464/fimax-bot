...
async def cmd_privacy(message: types.Message):
    privacy_text = (
        "🔒 <b>Политика конфиденциальности и Условия использования (Privacy Policy & Terms)</b>\n\n"
        "Используя бота FiMax, вы соглашаетесь со следующими условиями:\n\n"
        "<b>1. Сбор данных:</b> Мы собираем и храним только ваш Telegram ID, публичный никнейм (username) "
        "и статус вашей подписки. Мы не имеем доступа к вашим личным перепискам или паролям.\n"
        "<b>2. Использование данных:</b> Ваши данные используются исключительно для авторизации в приложении, "
        "синхронизации аккаунта и предоставления аналитики портфеля.\n"
        "<b>3. Платежи:</b> Все платежи обрабатываются безопасно через систему Telegram Stars. "
        "Мы не запрашиваем и не храним данные ваших банковских карт.\n"
        "<b>4. Удаление данных:</b> Вы можете запросить полное удаление вашего аккаунта и данных в любой момент, "
        "обратившись в поддержку.\n\n"
        "<i>Продолжая использовать бота и мини-приложение, вы даете согласие на обработку этих данных.</i>"
    )
